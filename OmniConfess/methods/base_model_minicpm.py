# -*- coding: utf-8 -*-
"""
base_model_minicpm.py — MiniCPM-o-2.6 single-pass greedy baseline.

Supports: haloquest (image), avhbench (audio+video), halueval/ragtruth (text)

Usage:
    CUDA_VISIBLE_DEVICES=1 python base_model_minicpm.py \
        --datasets avhbench --data_path ./OmniHalluBench/avhbench/avh_converted.json \
        --output_dir ./results --file_name minicpm_avh_v0 --max_samples 2
"""
...
def main():
    ...
    parser.add_argument('--file_name', type=str, default='minicpm_out')
    ...
    for idx, item in enumerate(data):
        ...
        result = make_result(item, response, args.datasets, 'minicpm_o',
                             time_sec=elapsed)
